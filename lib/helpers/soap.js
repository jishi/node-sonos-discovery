...
const TEMPLATES = Object.freeze({
  ...
  [TYPE.SetPlayMode]: '<u:SetPlayMode xmlns:u="un:schemas-upnp-org:service:AVTransport:1"><InstanceID>0</InstanceID><NewPlayMode>{playMode}</NewPlayMode></u:SetPlayMode>',
