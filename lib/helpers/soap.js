...
const TEMPLATES = Object.freeze({
  ...
  [TYPE.SetLoudness]: '<u:SetLoudness xmlns:u="urn:schemas-upnp-org:service:RenderingControl:1"><InstanceID>0</InstanceID><Channel>Master</Channel><DesiredLoudness>{enabled}</DesiredLoudness></u:SetLoudness>',
});
