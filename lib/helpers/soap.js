...
const TYPE = Object.freeze({
  ...
  GetLEDState: 'urn:schemas-upnp-org:service:DeviceProperties:1#GetLEDState',
  SetLEDState: 'urn:schemas-upnp-org:service:DeviceProperties:1#SetLEDState'
});
...
const TEMPLATES = Object.freeze({
  ...
  [TYPE.GetLEDState]: '<u:GetLEDState xmlns:u="urn:schemas-upnp-org:service:DeviceProperties:1"><InstanceID>0</InstanceID></u:GetLEDState>',
  [TYPE.SetLEDState]: '<u:SetLEDState xmlns:u="urn:schemas-upnp-org:service:DeviceProperties:1"><DesiredLEDState>{state}</DesiredLEDState></u:SetLEDState>'
});
