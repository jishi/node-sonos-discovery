...
const TYPE = Object.freeze({
  ...
  SetLoudness: 'urn:schemas-upnp-org:service:RenderingControl:1#SetLoudness',
});
...
const TEMPLATES = Object.freeze({
  ...
  [TYPE.SetLoudness]: '<u:SetLoudness xmlns:u="urn:schemas-upnp-org:service:RenderingControl:1"><InstanceID>0</InstanceID><Channel>Master</Channel><DesiredLoudness>{loudness}</DesiredLoudness></u:SetLoudness>',
});
