...
Player.prototype.mute = function (isMute) {
...
Player.prototype.groupMute = function(isMute){
    console.log('player set Group mute', isMute);
    var muteSoapGroup = SOAP.GroupMute.format({mute: isMute});
    ...
    var req = http.request({
        ...
        headers: {
            ...
            'CONTENT-LENGTH': muteSoapGroup.length
        }
    });
    req.write(muteSoapGroup);
    req.end();
};
